    ...
    <h2 class="text-[0.65rem] font-bold text-blue-200/70 tracking-[0.2em] leading-tight text-center uppercase">
        ...
        @php
            ...
            $menuConfig = [
                ...
                'history' => ['label' => 'Riwayat Pengiriman', 'icon' => '<path stroke-linecap="round" stroke-linejoin="round" d="M12 8v4l2.5 1.5M3.5 12a8.5 8.5 0 101.8-5.25M3.5 4.5v3.25h3.25" />'],
            ...
            <div class="flex items-center gap-4 pointer-events-auto">
                ...
                <div class="hidden lg:flex items-center gap-3">
                    ...
                    <div class="flex flex-col leading-tight">
                        ...
                        <span class="text-[0.7rem] font-bold text-slate-700 tracking-wide uppercase font-serif opacity-80">UP3 BOJONEGORO</span>
                    </div>
                </div>
            </div>

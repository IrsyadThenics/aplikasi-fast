                ...
                <table class="w-full text-xs border-collapse">
                    <thead class="sticky top-0 z-10">
                        ...
                        <tr class="bg-white hover:bg-slate-50 transition border-b border-slate-100 text-slate-700">
                            ...
                            <td class="border border-slate-200 px-3 py-2 text-center" id="berkas-jtm-{{ $item->no_agenda ?? $loop->index }}">
    ...
    <div class="bg-white rounded-xl shadow-2xl w-full max-w-4xl relative overflow-hidden flex flex-col border border-slate-200">
        ...
        <div class="p-6 text-[13.5px] text-slate-800 font-mono flex flex-col gap-4">
            ...
            <div class="bg-amber-50/60 border border-amber-200 rounded-lg p-3 flex flex-col gap-2">
                ...
                <div id="wo-controls_jtm" class="flex items-center gap-2 flex-wrap">
                ...
                <div id="wo-checklist_jtm" class="hidden items-center gap-2 bg-white px-3 py-2 border border-amber-200 rounded-lg shadow-sm w-fit mt-1">
                    <input type="checkbox" id="wo-check-status_jtm" disabled class="w-4 h-4 text-emerald-600 rounded border-slate-300">

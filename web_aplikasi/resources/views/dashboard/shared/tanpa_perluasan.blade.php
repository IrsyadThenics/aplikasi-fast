...
<!-- Detail Modal -->
<div id="detailModal_tp" class="fixed inset-0 z-[100] hidden items-center justify-center bg-black/50 backdrop-blur-sm p-4 overflow-y-auto">
        ...
        <div class="p-6 text-[13.5px] text-slate-800 font-mono flex flex-col gap-4">
            ...
            <div id="wo-section_tp" class="bg-amber-50/60 border border-amber-200 rounded-lg p-3 flex flex-col gap-2">
                <div class="font-bold text-amber-800 uppercase tracking-wider flex items-center gap-1.5 text-[13px]">
                    ...
                    <span id="wo-title_tp">Berkas WO</span>
                </div>

                {{-- Perencanaan: Upload WO --}}
                <div id="wo-controls_tp" class="hidden flex-col gap-2">
                    <label class="block text-[11px] font-bold text-slate-500 mb-1.5 uppercase tracking-wider">Berkas WO</label>
                    <div class="flex items-center gap-2">
                        <input type="file" id="tp-mdl-wo-input" accept=".pdf,.jpg,.jpeg,.png" class="text-xs border border-slate-300 rounded-lg p-1.5 w-full bg-white" onchange="handleWoUpload_tp(this)" />
                    </div>
                    <ul id="tp-mdl-wo-list" class="flex flex-col gap-1 mt-1"></ul>
                </div>

                {{-- Transaksi: Upload Excel --}}
                <div id="excel-controls_tp" class="hidden flex-col gap-2">
                    <div class="flex items-center gap-2 flex-wrap">
                        <label class="cursor-pointer flex items-center gap-1.5 bg-emerald-600 hover:bg-emerald-700 text-white text-xs font-bold px-3 py-1.5 rounded-lg shadow-sm transition">
                            ...
                            Pilih File Excel
                            <input type="file" id="tp-mdl-excel-input" class="hidden" accept=".xlsx,.xls,.csv" onchange="handleExcelUpload_tp(this)" />
                        </label>
                ...
                <div id="wo-checklist_tp" class="hidden flex-col gap-2">
                    <div class="flex items-center gap-2 bg-white px-3 py-2 border border-amber-200 rounded-lg shadow-sm">
                        <input type="checkbox" id="wo-check-status_tp" disabled class="w-4 h-4 accent-emerald-600 rounded border-slate-300">
                    ...
                    <div class="flex items-center gap-2 bg-white px-3 py-2 border border-amber-200 rounded-lg shadow-sm">
                        <input type="checkbox" id="excel-check-status_tp" disabled class="w-4 h-4 accent-emerald-600 rounded border-slate-300">
...
function kirimVendor_tp() {
    var pt = document.getElementById('tp-mdl-pt').value;
...
function renderWoList_tp(agendaKey) {
    ...
    req.onsuccess = function(e) {
        ...
        gr.onsuccess = function() {
            ...
            var ctrlWo    = document.getElementById("wo-controls_tp");
            var ctrlXls   = document.getElementById("excel-controls_tp");
            var ctrlChk   = document.getElementById("wo-checklist_tp");
            var titleEl   = document.getElementById("wo-title_tp");
            var chkWo     = document.getElementById("wo-check-status_tp");
            var chkXls    = document.getElementById("excel-check-status_tp");

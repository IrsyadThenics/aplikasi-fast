    ...
    <div class="bg-white rounded-xl shadow-2xl w-full max-w-4xl relative overflow-hidden flex flex-col border border-slate-200">
        ...
        <div class="p-6 text-[13.5px] text-slate-800 font-mono flex flex-col gap-4">
            ...
            <div class="bg-amber-50/60 border border-amber-200 rounded-lg p-3 flex flex-col gap-2">
                ...
                <div id="wo-controls_jtr" class="hidden flex-col gap-2">
                    <label class="block text-[11px] font-bold text-slate-500 mb-1.5 uppercase tracking-wider">Berkas WO</label>
                    <div class="flex items-center gap-2">
                        <input type="file" id="jtr-mdl-wo-input" accept=".pdf,.jpg,.jpeg,.png" class="text-xs border border-slate-300 rounded-lg p-1.5 w-full bg-white" onchange="handleWoUpload_jtr(this)" />
                    </div>
                    <ul id="jtr-mdl-wo-list" class="flex flex-col gap-1 mt-1"></ul>
                </div>

                {{-- Transaksi: Upload Excel --}}
                <div id="excel-controls_jtr" class="hidden flex-col gap-2">
                ...
                <div id="wo-checklist_jtr" class="hidden flex-col gap-2">
                    <div class="flex items-center gap-2 bg-white px-3 py-2 border border-amber-200 rounded-lg shadow-sm">
                        <input type="checkbox" id="wo-check-status_jtr" disabled class="w-4 h-4 accent-emerald-600 rounded border-slate-300">
...
function renderWoList_jtr(agendaKey) {
    ...
    req.onsuccess = function(e) {
        ...
        gr.onsuccess = function() {
            ...
            var ctrlWo    = document.getElementById("wo-controls_jtr");
            var ctrlXls   = document.getElementById("excel-controls_jtr");
            var ctrlChk   = document.getElementById("wo-checklist_jtr");
            var titleEl   = document.getElementById("wo-title_jtr");
            var chkWo     = document.getElementById("wo-check-status_jtr");
            var chkXls    = document.getElementById("excel-check-status_jtr");

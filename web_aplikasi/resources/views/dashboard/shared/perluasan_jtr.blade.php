        ...
        <div class="p-6 text-[13.5px] text-slate-800 font-mono flex flex-col gap-4">
            ...
            <div class="grid grid-cols-[150px_1fr] gap-2 items-center bg-blue-50/50 p-3 rounded-lg border border-blue-100">
                ...
                <div class="flex items-center gap-2">
                    ...
                    <input type="number" id="jtr-mdl-rab-input" class="border border-slate-300 rounded-lg px-3 py-1.5 text-sm w-40 focus:outline-none focus:ring-2 focus:ring-[#2B73FE] transition bg-white" placeholder="0" />

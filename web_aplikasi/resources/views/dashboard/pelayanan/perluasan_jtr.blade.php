    ...
    function renderTable(items) {
        ...
        items.forEach(function(item, i) {
            ...
            tr.innerHTML =
                ...
                '<td class="border border-slate-200 px-3 py-2 text-center">' + (item.day_lama || '-') + ' VA</td>' +
                '<td class="border border-slate-200 px-3 py-2 text-center font-semibold text-blue-900">' + (item.tarif_baru || '-') + '</td>' +
                '<td class="border border-slate-200 px-3 py-2 text-center font-semibold text-blue-900">' + (item.day_baru || '-') + ' VA</td>' +

    ...
    <div class="bg-white rounded-2xl shadow-md border border-slate-200 overflow-hidden flex-shrink-0">
        ...
        <div class="bg-gradient-to-r from-[#0D1B8C] to-[#0D1B8C] px-6 py-3 flex items-center gap-3">
            ...
            <div>
                ...
                <p class="text-blue-100 text-xs">Laporan PB/PD (Peremajaan & Bayar)</p>
            </div>
        </div>
        ...
        <div class="px-6 py-4">
            <div class="grid grid-cols-3 gap-4 mb-4">
                ...
                <div>
                    ...
                    <select class="w-full border border-slate-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-400 bg-slate-50 text-slate-700 transition"><option>--- semua ---</option><option>Perluasan JTM</option><option>Perluasan JTR</option><option>Tanpa Perluasan</option></select>
                </div>
                {{-- Status --}}
                <div>
                    ...
                    <select class="w-full border border-slate-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-400 bg-slate-50 text-slate-700 transition">
                        <option>--- semua ---</option>
                        <option>Bayar</option>
                        <option>Cetak PK</option><option>Pengesahan PDL</option><option>Peremajaan</option><option>Perluasan</option>
                    </select>
                </div>
            </div>
        ...
        <div class="bg-white rounded-2xl shadow-md border border-slate-200 flex flex-col flex-1 min-h-0 overflow-hidden">
            ...
            <div class="bg-gradient-to-r from-[#0D1B8C] to-[#0D1B8C] px-5 py-2.5 flex items-center justify-between flex-shrink-0">
                <div class="flex items-center gap-2">
                    <span class="text-white font-bold text-sm tracking-wide">RECORD, DATA LAPORAN</span>

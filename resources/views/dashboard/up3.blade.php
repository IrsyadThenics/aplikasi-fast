...
<div class="w-full max-w-7xl mx-auto h-full flex flex-col gap-6 pt-2">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
        ...
        <div class="glass-card p-5 h-32 flex flex-col relative group cursor-pointer transition-transform hover:-translate-y-1">
            ...
            <div class="flex items-center gap-4 relative z-10">
                ...
                <div class="flex flex-col">
                    <span class="text-3xl font-extrabold text-slate-800 tracking-tight leading-none mb-1">1,250</span>
                    <span class="text-[0.8rem] font-semibold text-slate-600">Total PB/PD (UP3)</span>
                </div>
            </div>
        </div>
        ...
        <div class="glass-card p-5 h-32 flex flex-col relative group cursor-pointer transition-transform hover:-translate-y-1">
            ...
            <div class="flex items-center gap-4 relative z-10">
                ...
                <div class="flex flex-col">
                    <span class="text-3xl font-extrabold text-slate-800 tracking-tight leading-none mb-1">840</span>
                    <span class="text-[0.8rem] font-semibold text-slate-600">Proses UP3</span>
                </div>
            </div>
        </div>
        ...
        <div class="glass-card p-5 h-32 flex flex-col relative group cursor-pointer transition-transform hover:-translate-y-1">
            ...
            <div class="flex items-center gap-4 relative z-10">
                ...
                <div class="flex flex-col">
                    <span class="text-3xl font-extrabold text-slate-800 tracking-tight leading-none mb-1">410</span>
                    <span class="text-[0.8rem] font-semibold text-slate-600">Selesai UP3</span>
                </div>
            </div>
        </div>
        ...
        <div class="glass-card p-5 h-32 flex flex-col relative group cursor-pointer transition-transform hover:-translate-y-1">
            ...
            <div class="flex items-center gap-4 relative z-10">
                ...
                <div class="flex flex-col">
                    <span class="text-3xl font-extrabold text-slate-800 tracking-tight leading-none mb-1">112</span>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 flex-1 min-h-[300px]">
        ...
        <div class="glass-card p-6 flex flex-col relative h-full">
            ...
            <h3 class="font-bold text-sm text-slate-700 leading-tight z-10">Layanan Type UP3</h3>

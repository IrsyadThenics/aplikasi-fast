    ...
    <div class="bg-white rounded-2xl shadow-md border border-slate-200 overflow-hidden flex-shrink-0">
        ...
        <div class="bg-gradient-to-r from-[#0D1B8C] to-[#0D1B8C] px-6 py-3 flex items-center gap-3">
            ...
            <div>
                ...
                <p class="text-blue-100 text-xs">Daftar Transaksi Proses Perluasan UP3 Bojonegoro</p>
            </div>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-md border border-slate-200 flex flex-col flex-1 min-h-0 overflow-hidden">
            ...
            <div class="bg-gradient-to-r from-[#0D1B8C] to-[#0D1B8C] px-5 py-2.5 flex items-center justify-between flex-shrink-0">
                <div class="flex items-center gap-2">
                    <span class="text-white font-bold text-sm tracking-wide">RECORD, JUMLAH TRANSAKSI PROSES PERLUASAN</span>
...
<div id="detailModal" class="fixed inset-0 z-[100] hidden items-center justify-center bg-black/50 backdrop-blur-sm p-4 overflow-y-auto">
    <div class="bg-white w-full max-w-5xl relative border border-slate-300 shadow-xl my-4">
        ...
        <div class="absolute top-10 right-6 text-blue-700 font-bold text-lg uppercase tracking-widest z-10">
            LAYAK
        </div>
        ...
        <div class="px-4 py-3 text-[11px] font-mono text-slate-800 grid grid-cols-[160px_1fr] gap-y-0.5">
            ...
            <div>: <span class="text-slate-800" id="mdl-ktp">-</span></div>
            <div class="font-semibold uppercase">Ijin Tanam Tiang</div>
            <div>: <span class="text-slate-800" id="mdl-itt">-</span></div>

            <div class="col-span-2 border-t border-dashed border-slate-300 my-1"></div>

            <div class="font-semibold uppercase">Vendor KHS</div>
            <div class="flex items-center gap-1">:
                <select class="ml-1 border border-slate-300 rounded px-2 py-0.5 text-[11px] bg-white text-slate-800 focus:outline-none">
                    <option>PT. KARUNIA JAYA ELEKTRIKA</option>
                    <option>PT. GLOBAL ABADI</option>
                </select>
            </div>
        </div>
            ...
            <table class="w-full border-collapse text-[10.5px] text-center font-mono">
                ...
                <tbody>
                    ...
                    <tr class="font-mono">
                        ...
                        <td class="border border-slate-400 px-2 py-1" id="mdl-tgl-survey"></td>
                        <td class="border border-slate-400 px-2 py-1 bg-cyan-300 font-bold" id="mdl-tgl-checklist">-</td>
                        <td class="border border-slate-400 px-2 py-1"></td>
        ...
        <div class="px-4 py-2 border-t border-slate-200 flex flex-wrap items-center gap-2 text-[11px] font-mono bg-white">
            <span class="font-semibold">Hasil Checklist :</span>
            <input type="date" class="border border-slate-300 rounded px-2 py-0.5 text-[11px] text-slate-800 focus:outline-none" id="mdl-checklist-date" />
...
function openDetailModal(item) {
    ...
    document.getElementById('mdl-tgl-checklist').textContent = ds;
    
    let elChecklistDate = document.getElementById('mdl-checklist-date');
    if(elChecklistDate) elChecklistDate.value = ds;

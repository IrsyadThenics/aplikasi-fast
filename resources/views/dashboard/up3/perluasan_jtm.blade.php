...
<div class="container mx-auto mt-8 px-4">
    <div class="bg-white p-6 rounded-xl border border-gray-200 shadow-sm min-h-[400px]">
        <h2 class="text-xl font-bold text-gray-800 mb-4">Perluasan JTM</h2>
        <p class="text-gray-600">Halaman ini sedang dalam pengembangan atau menunggu integrasi data.</p>
    </div>
</div>
@endsection
@extends('layouts.app')
...
<div class="h-full flex flex-col bg-slate-50 p-5">
    ...
    <div class="bg-white rounded-2xl shadow-md border border-slate-200 overflow-hidden flex-shrink-0">
        ...
        <div class="bg-gradient-to-r from-[#1e4d8c] to-[#3b6ea5] px-6 py-3 flex items-center gap-3">
            ...
            <div>
                <p class="text-white font-bold text-sm tracking-wide">DAFTAR PERLUASAN JTM</p>
                <p class="text-blue-100 text-xs">Daftar Perluasan JTM UP3 Bojonegoro</p>
            </div>
        </div>
